...
class ProxiesPage(QtWidgets.QWidget):
    ...
    def setupUi(self, proxiespage):
        ...
        self.proxiespage.setStyleSheet(
        ...
        self.proxies_card.setStyleSheet(
        ...
        self.editproxies_header.setStyleSheet(
        ...
        self.listname_edit.setStyleSheet(
        ...
        self.loadlist_box.setStyleSheet(
            "outline: 0;border: 1px solid #5D43FB;border-width: 0 0 2px;color: rgb(234, 239, 239);"
        )
        ...
        self.saveproxies_btn.setStyleSheet(
        ...
        self.deleteproxies_btn.setStyleSheet(
            "color: #FFFFFF;background-color: #5D43FB;border-radius: 10px;border: 1px solid #2e2d2d;"
        )
            ...
            for item in proxies.splitlines():
                if ":" not in item or item == "":
                    QtWidgets.QMessageBox.critical(
                        self, "Bird Bot", "Incorrect Proxies"
                    )
                    return
            proxies_data = {
                "list_name": list_name,
    ...
    def delete_proxies(self):
        ...
        self.parent().parent().createdialog.proxies_box.removeItem(
            self.parent().parent().createdialog.proxies_box.findText(list_name)
        )
