...
class SettingsPage(QtWidgets.QWidget):
    ...
    def setupUi(self, settingspage):
        ...
        self.settingspage.setStyleSheet(
            "QComboBox::drop-down {    border: 0px;}QComboBox::down-arrow {    image: url(:/images/down_icon.png);    width: 14px;    height: 14px;}QComboBox{    padding: 1px 0px 1px 3px;}QLineEdit:focus {   border: none;   outline: none;}") # don't know if this line is needed
        ...
        font.setPointSize(22) if platform.system(
        ) == "Darwin" else font.setPointSize(22*.75)
        font.setWeight(50)
        ...
        font = QtGui.QFont()
        font.setPointSize(13) if platform.system(
        ) == "Darwin" else font.setPointSize(13*.75)
        font.setFamily("Arial")
        self.settings_card.setFont(font)
        self.settings_card.setStyleSheet(
            "background-color: #232323;border-radius: 20px;border: 1px solid #2e2d2d;")
        
        self.webhook_header = QtWidgets.QLabel(self.settings_card)
        self.webhook_header.setGeometry(QtCore.QRect(20, 10, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(18) if platform.system(
        ) == "Darwin" else font.setPointSize(18*.75)
        font.setWeight(50)
        self.webhook_header.setFont(font)
        self.webhook_header.setStyleSheet(
            "color: rgb(212, 214, 214);border:  none;")
        ...
        self.webhook_edit.setStyleSheet(
        ...
        self.browser_checkbox.setGeometry(QtCore.QRect(30, 90, 125, 20))
        ...
        self.paymentfailed_checkbox.setStyleSheet(
        ...
        self.general_header.setStyleSheet(
            "color: rgb(212, 214, 214);border:  none;")
        ...
        self.savesettings_btn.setCursor(
    ...
    # initializes form data from settings.json
    def set_data(self):
    ...
    def update_settings(self, settings_data):
        ...
        settings.webhook, settings.webhook_on_browser, settings.webhook_on_order, settings.webhook_on_failed, settings.browser_on_failed, settings.buy_one = settings_data[
            "webhook"], settings_data["webhookonbrowser"], settings_data["webhookonorder"], settings_data["webhookonfailed"], settings_data["browseronfailed"], settings_data['onlybuyone']
