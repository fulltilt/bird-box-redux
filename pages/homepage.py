...
class HomePage(QtWidgets.QWidget):
    ...
    def setupUi(self, homepage):
        ...
        self.homepage.setAttribute(QtCore.Qt.WA_StyledBackground, True) # enable stylesheet
        self.homepage.setGeometry(QtCore.QRect(60, 0, 1041, 601)) # position homepage window 60px to the right so it doesn't cover sidebar
        ...
        self.tasks_card.setGeometry(QtCore.QRect(30, 110, 991, 461)) # positions window relative to homepage window
