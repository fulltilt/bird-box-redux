...
class HomePage(QtWidgets.QWidget):
    ...
    def setupUi(self, homepage):
        ...
        # main homepage window
        self.homepage = homepage
        self.homepage.setAttribute(
            QtCore.Qt.WA_StyledBackground, True
        )  # enable stylesheet
        self.homepage.setGeometry(
            QtCore.QRect(60, 0, 1041, 601)
        )  # position homepage window 60px to the right so it doesn't cover sidebar
        ...
        # window that contains table of tasks
        self.tasks_card = QtWidgets.QWidget(self.homepage)
        self.tasks_card.setGeometry(
            QtCore.QRect(30, 110, 991, 461)
        )  # positions window relative to homepage window
        ...
        self.tasks_total_card.setStyleSheet(
            "background-color: #232323;border-radius: 10px;border: 1px solid #2e2d2d;"
        )
        ...
        self.checkouts_count.setGeometry(QtCore.QRect(41, 10, 31, 31))
...
# represents each line on the table. Each line is a task
class TaskTab(QtWidgets.QWidget):
    def __init__(
        ...
        tasks_total_count.setText(
            self.task_id
        )  # I guess total count gets updated each time this is run?
        (
            self.site,
            self.product,
            self.profile,
    ...
    def setupUi(self, TaskTab):
        ...
        # I guess this shows up on errors
        ...
        # not sure what these labels are for or when they show up
    ...
    # this sets the text for each table cell
