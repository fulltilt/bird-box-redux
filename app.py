...
import images.images  # references images.py in images folder
import sys
import os
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.home_tab.setGeometry(QtCore.QRect(
            0, 85, 60, 45))  # (x, y, width, height)
    ...
    def change_page(self, event, current_page):
        ...
        eval('self.{}_icon.setPixmap(QtGui.QPixmap(":/images/{}_alt.png"))'.format(
            self.current_page, self.current_page))
